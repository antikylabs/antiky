...
`packages/framework/scripts/api-reference-content.mjs` or the Framework generator, then run
`npm run docs:api --workspace @antiky/framework`; do not hand-edit generated pages.
