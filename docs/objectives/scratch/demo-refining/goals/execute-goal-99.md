...
| M7 | **A metric can move the wrong way.** The yellow canopy measured *higher* local contrast (9.25 against 8.63) while looking clearly worse. | Found while testing M5. | Feeds M1: a budget number rising is not on its own evidence that a change helped. Look at the frame. |
