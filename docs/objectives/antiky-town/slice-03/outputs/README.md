...
Each Slice 03 run creates one `outputs/{run-id}/` directory. Do not overwrite an earlier run.
...
- `measurements.json` for simulation, collision-query, and actor-upload measurements.
