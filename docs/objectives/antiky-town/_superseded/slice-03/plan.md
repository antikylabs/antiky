...
> **Superseded on 2026-08-07.** Do not execute this plan. The current roadmap requires a new Nexus
> and BroMetal qualification plan with a player-visible hero result.
...
| Depends on | [`../../_completed/slice-02/plan.md`](../../_completed/slice-02/plan.md) complete, including ADRs 0016 and 0017 |
