This goal completes [real demo projects](_completed/feedback-06-demo-projects-plan.md) and
[compiled website demos](_completed/feedback-07-website-demo-artifacts-plan.md).
...
5. [x] Complete both plans and record their passing results in [the Slice 00 summary](slice-summary.md).
