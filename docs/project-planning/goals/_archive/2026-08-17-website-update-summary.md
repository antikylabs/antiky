...
documents and the editable two-level roadmap DSL used by the future Roadmap page.
...
- Primary navigation remains seven items by replacing Assets with Resources. `/assets` remains the
  canonical CC0 catalog route.
...
- Framework, Studio, and Research are each classified and written as Explanation pages for one
  defined reader.
- Metadata titles are at most 60 characters and descriptions are at most 160 characters.
