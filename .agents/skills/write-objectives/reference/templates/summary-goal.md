...
**Commits:** `<sha>`, `<sha>`
**Goal file:** [`execute-goal-NN.md`](execute-goal-NN.md)
...
<!-- What was run and what it produced. Commands, test names, measurements. -->

| Check | Result |
|---|---|
| <the assertion from the goal> | <what was observed> |

## What this unblocks

- <goal or work now able to start>

## What remains blocked

- <what is still waiting, and on what>
