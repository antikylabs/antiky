...
import { createDevelopmentActionBroker } from '../../../src/host/inspection/actions.ts';
// @ts-ignore direct TypeScript source import for the Node strip-types runner
import { createEvidenceStore } from '../../../src/host/capture/evidence-store.ts';
// @ts-ignore direct TypeScript source import for the Node strip-types runner
import {
  parseCaptureFrameRequestV2,
  parseCaptureFrameRequestV3,
} from '../../../src/development/capture/index.ts';
