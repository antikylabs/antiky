...
restart instead of repeating the unanswered decision. These exact todo.txt tags are the control
signal; the words COMPARE and DECIDE in ordinary task prose do not affect the loop. A dry run
reports the number of upcoming comparison tasks and decision gates at the top of its summary.
