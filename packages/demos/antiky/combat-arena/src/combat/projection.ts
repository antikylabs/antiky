...
import { COMBAT_PALETTE, enemyVisualProfile } from './visuals.ts';
import {
...
import { ENEMY_COUNT, PROJECTILE_CAPACITY, type CombatEnemy, type CombatSnapshot, type EnemyRole } from './state.ts';
