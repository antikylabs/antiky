...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  ...
  let dampEarth = mix(diffuseSample, vec3f(litterGrey, litterGrey, litterGrey), 0.93) * bm_u.uDiffuseTint;
