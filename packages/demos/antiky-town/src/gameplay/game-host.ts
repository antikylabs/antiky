...
const HOST_BY_INSTANCE = new WeakMap<GameInstance, AntikyTownGameHost>();

export function captureTownSemanticInput(movement: GameMovementInput): TownSemanticInput {
...
export function getAntikyTownGameHost(instance: GameInstance | null): AntikyTownGameHost | null {
