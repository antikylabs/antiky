 ...
 *
 * Copied by hand from `combat-arena`, which took it from `point-light-expo`.
 *
 * What it replaces here was worse: this demo drew its contact shadow as an **opaque squashed sphere
 * through `traversal-surface`**, so the blob was lit, fogged and tone-mapped like scenery while its
 * normals stayed spherical — the hole punched in the platform the goal file describes.
 *
