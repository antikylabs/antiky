# Portrait launch announcement prompt record
...
- Generated source retained at:
  `/Users/josephduncan/.codex/generated_images/01a022d2-3a98-77c3-833f-eb663d107c13/exec-e84f05ff-f2ed-462c-85d2-3f524c80e805.png`
...
Asset type: text-free launch announcement artwork, portrait 4:5

Input images:
Image 1: composition and brand-restraint reference only. Preserve its near-black editorial confidence, amber/cool-violet balance, generous quiet regions, and disciplined contrast. Do not reproduce its website interface, copy, or exact game scene.
...
Composition/framing: portrait 4:5 composition designed natively for a social announcement, not cropped from landscape or square. Place the complete maquette in the middle/lower 65% of the frame, leave calm near-black space above for external campaign typography, and preserve side breathing room so the mobile presentation is not cramped.
...
Output intent: portrait launch announcement art. The pixels carry mood only and will be labeled Illustrative.
